...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold" style="color:#c02f5a">Test Information</h6>
                                </div>
                                <div class="card-body">
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold " style="color:#c02f5a" align="center">Test  Tracking History</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
