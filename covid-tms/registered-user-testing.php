...
<div class="form-group">
                                 <input type="submit" class="btn btn-info btn-user btn-block" name="search" value="Search">                           
                             </div>
...
<form name="newtesting" method="post">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold"style="color:#c02f5a">Personal Information</h6>
                                </div>
                                <div class="card-body">
                        <div class="form-group">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold"style="color:#c02f5a">Testing Information</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                       ...
                       <div class="form-group">
                                 <input type="submit" class="btn btn-info btn-user btn-block" name="submit">                           
                             </div>
